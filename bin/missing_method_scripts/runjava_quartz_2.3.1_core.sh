...
BENCHMARK_PATH="$MACHINE_SPECIFIC_PATH/Benchmarks/quartz-quartz-2.3.1-patched/quartz-core"
BENCHMARK="quartz_2.3.1_quartz_core"
...
echo java -cp $SOOT_JAR:$JAVA_PATH $CC_CLASS $BENCHMARK_PATH/$TARGET_PATH `cat benchmark_class_path`:$JAR_PATH quartz_core_2.3.1_missing_methods.csv $BENCHMARK
java -cp $SOOT_JAR:$JAVA_PATH $CC_CLASS $BENCHMARK_PATH/$TARGET_PATH `cat benchmark_class_path`:$JAR_PATH quartz_core_2.3.1_missing_methods.csv $BENCHMARK
