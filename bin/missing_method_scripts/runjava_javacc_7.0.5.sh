...
BENCHMARK_PATH="$MACHINE_SPECIFIC_PATH/Benchmarks/javacc-7.0.5-patched"
BENCHMARK="javacc_7.0.5"
...
echo java -cp $SOOT_JAR:$JAVA_PATH $CC_CLASS $BENCHMARK_PATH/$TARGET_PATH $jars`cat benchmark_class_path`:$JAR_PATH javacc_7.0.5_missing_methods.csv $BENCHMARK
java -cp $SOOT_JAR:$JAVA_PATH $CC_CLASS $BENCHMARK_PATH/$TARGET_PATH $jars`cat benchmark_class_path`:$JAR_PATH javacc_7.0.5_missing_methods.csv $BENCHMARK
