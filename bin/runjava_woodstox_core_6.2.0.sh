...
BENCHMARK_PATH="$MACHINE_SPECIFIC_PATH/Benchmarks/woodstox-woodstox-core-6.2.0-patched"
BENCHMARK="woodstox_core_6.2.0"
...
echo java -cp $SOOT_JAR:$JAVA_PATH $CC_CLASS $BENCHMARK_PATH/$TARGET_PATH $jars`cat benchmark_class_path`:$JAR_PATH woodstox_core_6.2.0_missing_methods.csv $BENCHMARK
java -cp $SOOT_JAR:$JAVA_PATH $CC_CLASS $BENCHMARK_PATH/$TARGET_PATH $jars`cat benchmark_class_path`:$JAR_PATH woodstox_core_6.2.0_missing_methods.csv $BENCHMARK
