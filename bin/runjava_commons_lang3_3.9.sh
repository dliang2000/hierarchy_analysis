...
echo java -cp $SOOT_JAR:$JAVA_PATH $CC_CLASS $BENCHMARK_PATH/$TARGET_PATH $jars$TARGET_PATH:$JAR_PATH commons_lang3_3.9_src_missing_methods.csv
java -cp $SOOT_JAR:$JAVA_PATH $CC_CLASS $BENCHMARK_PATH/$TARGET_PATH $jars$TARGET_PATH:$JAR_PATH commons_lang3_3.9_src_missing_methods.csv
