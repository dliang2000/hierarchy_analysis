...
BENCHMARK_PATH="$MACHINE_SPECIFIC_PATH/Benchmarks/byte-buddy-byte-buddy-1.10.10-patched"
TARGET_PATH="target/classes"
TARGET_TEST_PATH="target/test-classes"
BENCHMARK="byte_buddy_byte_buddy_dep_1.10.10"
DRIVER_PATH="net.bytebuddy.Driver"
OUTPUT_PATH="$MACHINE_SPECIFIC_PATH/analysis_output/MockAnalysis"

MVN_DEPENDENCY_PATH="$BENCHMARK_PATH/byte-buddy-dep/mvn_dependencies"
