...
xml_file = '/home/vagrant/benchmarks/findbugs-3.0.1/findbugs_3.0.1_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/findbugs_3.0.1_missing_methods.csv', 'w', newline='') as outcsv:
