...
xml_file = '/home/vagrant/benchmarks/joda-time-2.10.5/joda_time_2.10.5_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/joda_time_2.10.5_missing_methods.csv', 'w', newline='') as outcsv:
