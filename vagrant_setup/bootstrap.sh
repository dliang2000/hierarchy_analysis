...
case $(id -u) in
  ...
  ( cd commons-lang3-3.9-src; python3 /vagrant/shared/python_scripts/commons_lang3_3.9_src_processing.py )
    ...
    ( cd jgrapht-jgrapht-1.3.1; java -jar /vagrant/shared/jacoco-0.8.5/lib/jacococli.jar report ./target/coverage-reports/jacoco-ut.exec --classfiles ./target/classes/ --xml ./javacc_7.0.5_coverage.xml )
    ( cd jgrapht-jgrapht-1.3.1; python3 /vagrant/shared/python_scripts/javacc_7.0.5_processing.py )
